...
def errormsg():
    return render_template('index.html',click="Return to the main page", wiki="Error <br> <br> Please return to the home page.")

@app.route('/')
def form():
    home = render_template('index.html', image = "<img src=" + os.path.join(app.config['UPLOAD_FOLDER'], "epic" + str(randint(1,3)) +".jpg")+">", 
    wiki= "<br> + date/time <br> + weather <br> + weather on the Mars <br> + Picture of the day *on [Year-Month-Day]* <br> + International Space Station, ISS <br> + Search (using wikipedia) *title* <br> + News(Latest space exploration news)", TextTitle = "<h1> Keyword list </h1>",
    doc = "This is the main page of the program. ")
    return home
...
def main():
    ...
    if apod == 1:
        ...
        if "date" in user_input:
            ...
            return  render_template('index.html',click="Return to the main page", wiki = " The current time is: " + current_time + "<br> And the current date is: " + current_date)
        else:
            return render_template('index.html',click="Return to the main page", wiki="The current time is: " + current_time)
        ...
        now = datetime.now()
        current_date = now.strftime("%D")
        return render_template('index.html', click="Return to the main page",wiki="The current date is: " + current_date)
        ...
        try:
            ...
            return render_template('index.html', click="Return to the main page",wiki="The average temperature on Mars in this month was: <br>"+ avg_temp + "C <br><br>" +
    ...
    #--------------------------------Weather--------------------------------#
        ...
        try:
            ...
            if x["cod"] != "404":
                ...
                return render_template('index.html',click="Return to the main page", image = img(imgpath), wiki = "The current temperature in " + city_name + " is: " + str(celsius).replace('(', '')[:3] + "C°" + "<br>" + "The weather in " + city_name + " is: " + str(weather_description))
        except:
            errormsg()
    #--------------------------------Weather--------------------------------#
        ...
        try:
            ...
            return render_template('index.html',click="Return to the main page", wiki = wikipedia.summary(new, sentences=5))
        except:
            return render_template('index.html', click="Return to the main page", wiki = "Wikipedia page was not found, type 'home' to return to the home page")
        ...
        if "on" in user_input:
            ...
            data = requests.get(f)
            gtt = json.loads(data.text)
            return render_template('index.html', click="Return to the main page", wiki = "The astronomy picture of the day is: " + "<br> <b>" + gtt["title"] + " </b> <br> <br>" +
                                    "Do you want to hear the explanation of this picture?", image = img(gtt["url"]))
        ...
        return render_template('index.html',click="Return to the main page", wiki=position, image='<iframe src="frame"></iframe>')

    elif "news" in user_input:
        title, summary, url, imgurl, = news()[0], news()[1], news()[2], news()[3]
        return render_template('index.html', click="Return to the main page", TextTitle='<h1 id="link">'+ '<a href="'+url+'">'  + title + "</a></h1>" + "<br>", wiki=summary, image='<img src="' + imgurl + '">'+'</a>',)
